...
int main(int argc, char* argv[])
{
	...
	*multiple = 0;
	if(my_rank != 0)
	{
		...
		processQueriesPathCompression(my_rank,queriesProcessX,queriesProcessY,queryNums,unionfindDs,pointIdMappingMain,numPointsPerProcess,num_processes, numQueries, numMessages, multiple); // num_process-1 coz process 0's work is complete
